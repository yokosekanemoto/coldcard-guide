...
### Prepare Instructions for Heirs and/or Executor
Print instructions for Heirs and/or Executor with information on bitcoin exchange accounts, spare hot wallets, and other digital assets.
The following is a sample letter which could be used by a digital-asset holder to alert their heirs of the existence of the digital assets. For a more complete info on this topic, see Pamela Morgan's book [Cryptoasset Inheritance Planning](https://t.co/hsLxiZdQya).
